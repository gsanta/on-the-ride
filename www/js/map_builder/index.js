...
(function() {
  ...
  module.factory('BicycleRouteBuilderService', require('./services/BicycleRouteBuilderService'));

  module.factory('InfoWindowService', require('./services/InfoWindowService'));

  module.factory('MapBuilderService', require('./services/MapBuilderService'));

}).call(this);

},{"./services/BicycleRouteBuilderService":2,"./services/InfoWindowService":3,"./services/MapBuilderService":4}],2:[function(require,module,exports){
(function() {
